ActiveAdmin.register SalarySlip, as: 'Salary Slip History' do
  ...
  form do |f|
    ...
    f.inputs 'Salary Slip Details' do
      ...
      f.input :salary, input_html: { readonly: true, value: f.object.employee&.salary_structure&.salary }
      f.input :allowances, input_html: { value: f.object.employee&.salary_structure&.allowances }
